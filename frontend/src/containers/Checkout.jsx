                ...
                <div class="shipment-details">
                    ...
                    <div class="details">
                        <form action="">
                            ...
                            <input type="text" placeholder="Enter Recipient's name" name="fullName" required />
                            <br></br>
                            <label for="phone">
                                Phone Number <br></br>
                            </label>
                            ...
                            <input type="text" placeholder="Enter Street address or P.O. Box" name="Address" required />
                            <br></br>
                            <label for="pincode">
                                PIN Code <br></br>
                            </label>
                            <input type="tel" placeholder="Enter Pin Code" name="pincode" pattern="[0-9]{6}" required />
                            <br></br>
                            <label for="Address2">
                            ...
                            <input type="text" placeholder="Enter City" name="Address" required />
                            <br></br>
                            <label for="State">
                                State<br></br>
                            </label>
